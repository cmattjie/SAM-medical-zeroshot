...
args = get_args()
dicts = json.load(open('code/utils/dicts.json', 'r'))
board = tensorboard.SummaryWriter(log_dir=f"runs/{args.name}")
...
for idx, batch in enumerate(tqdm(loader)):
    ...
    #calculate metrics
    dice_rc_0(y_pred=torch.Tensor(masks_rc[0,:,:]*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rc_1(y_pred=torch.Tensor((masks_rc[1,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rc_2(y_pred=torch.Tensor((masks_rc[2,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs3_0(y_pred=torch.Tensor(masks_rs3[0,:,:]*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs3_1(y_pred=torch.Tensor((masks_rs3[1,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs3_2(y_pred=torch.Tensor((masks_rs3[2,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs5_0(y_pred=torch.Tensor(masks_rs5[0,:,:]*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs5_1(y_pred=torch.Tensor((masks_rs5[1,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_rs5_2(y_pred=torch.Tensor((masks_rs5[2,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_cp_0(y_pred=torch.Tensor(masks_cp[0,:,:]*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_cp_1(y_pred=torch.Tensor((masks_cp[1,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_cp_2(y_pred=torch.Tensor((masks_cp[2,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_bb_0(y_pred=torch.Tensor(masks_bb[0,:,:]*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_bb_1(y_pred=torch.Tensor((masks_bb[1,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
    dice_bb_2(y_pred=torch.Tensor((masks_bb[2,:,:])*1).unsqueeze(0), y=torch.Tensor(mask[:,:,0]*1).unsqueeze(0))
